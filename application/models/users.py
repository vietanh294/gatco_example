...
class TinhThanh2(CommonModel):
    __tablename__ = 'tinhthanh2'
    id = db.Column(Integer, primary_key=True)
    ma = db.Column(String(255), unique=True)
    ten = db.Column(String(255), nullable=False)
    quocgia_id = db.Column(Integer, ForeignKey('quocgia.id'), nullable=False)
    tenquocgia = db.Column(String(255))
    #quocgia = db.relationship('QuocGia')
...
#     ma = db.Column(String(255), unique=True)
#     ten = db.Column(String(255), nullable=False)
#     pupil = db.relationship("Pupil", order_by="Pupil.id", cascade="all, delete-orphan")
#     
# 
# class Pupil(CommonModel):
#     __tablename__ = 'pupil'
#     id = db.Column(Integer, primary_key=True)
#     ma = db.Column(String(255), unique=True)
#     ten = db.Column(String(255), nullable=False)
...
#     ma = db.Column(String(255), unique=True)
#     ten = db.Column(String(255), nullable=False)
#     parent_id = db.Column(Integer, ForeignKey('parent.id', onupdate='CASCADE', ondelete='CASCADE'), nullable=False)
#     
# class Child2(CommonModel):
#     __tablename__ = 'child2'
#     id = db.Column(Integer, primary_key=True)
#     ma = db.Column(String(255), unique=True)
#     ten = db.Column(String(255), nullable=False)
#     parent_id = db.Column(Integer, ForeignKey('parent.id', onupdate='CASCADE', ondelete='SET NULL'))
